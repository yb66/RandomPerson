...
#   end
  ...
  def test_construction
    #default choice
    choice = choice = RandomPerson::Choice.new
    ...
    choice2 = choice = RandomPerson::Choice.new( gender_ratio:[2,1] )
    ...
    choice3 = choice = RandomPerson::Choice.new( age_lower: 20 )
    ...
    choice4 = choice = RandomPerson::Choice.new( age_upper: 50 )
    ...
    choice5 = choice = RandomPerson::Choice.new( gender_ratio:[10,1], age_upper: 105 )
